...
| :--- | :--- | :--- | :--- |
| **express** | `/ɪkˈspres/` | n. 特快列车；v. 表达，表示；adj. 明确的，特快的 | 源自拉丁语 expressus（挤出来的，清晰的），来自 exprimere（挤出，表达：ex- 出 + premere 压，与 press 同源），特快列车因其“不停靠中途站、直接派送”而得名。 |
| **journey** | `/ˈdʒɜːni/` | n. 旅行，旅程 | 源自古法语 journee（一天的行程，一天的工作），来自拉丁语 diurnus（一天的，来自 dies 天，与 diary 同源），指一天内能走完的距离。 |
| **schedule** | `/ˈʃedjuːl/` | n. 时间表，进度表；v. 安排 | 源自拉丁语 schedula（小纸条），来自希腊语 schede（写字板上的纸页），最初指列有清单的小纸片，后指日程表。 |
...
### 1. 定语从句中的介词置于关系代词前
* **经典原句**：*The train on which they travelled was late.*
* **核心解析**：
on which 引导定语从句修饰 train，介词 on 原本位于从句动词 travel 之后（travel on the train）。
...
* **句型名称**：Lesson 37 Writing Structure
...
* **Question 1**: How does the theme of Lesson 37 relate to our modern lifestyle and technology development?
