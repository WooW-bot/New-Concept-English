...
| :--- | :--- | :--- | :--- |
| **monastery** | `/ˈmɒnəstri/` | n. 修道院，僧院 | 源自希腊语 monasterion，来自 monazein（独居，独自生活），来自 monos（单独的，独创的，与 mono- 同源），指僧侣修行独居的地方。 |
| **saint** | `/seɪnt/` | n. 圣人，基督教圣徒 | 源自拉丁语 sanctus（神圣的，圣洁的，与 sanctuary 同源），在基督教中指被教会正式册封的圣人。 |
| **pass** | `/pɑːs/` | n. 关隘，通道；v. 通过，经过 | 源自拉丁语 passus（步子，步伐，来自 pandere 展步），引申为狭窄的通道或关隘。 |
...
### 1. 定语从句修饰地点 (Attributive Clause of Place)
* **经典原句**：*They visited the monastery where the monks lived.*
* **核心解析**：
where 引导定语从句，在从句中作地点状语，修饰表示地点的先行词 monastery。
...
* **句型名称**：Lesson 8 Writing Structure
...
* **Question 1**: How does the theme of Lesson 8 relate to our modern lifestyle and technology development?
